...
parser.add_argument('--num_epochs', type=int, default=3, dest="num_dp_epochs")
...
dptabgen.dp_tune(
    ...
    lr=LEARNING_RATE,
    save_log=True,
    log_file=f"./log/{DATASET}/nonDP_{SHORT_NAME}_TL{TARGET_LAST}{GAMMA}_NL{NUMERICAL_LOSS}_{TRAIN_SIZE}_{RANDOM_SEED}_{EPSILON}_{NUM_DP_EPOCHS}_{ALPHA}_{LEARNING_RATE}.txt",
    save_model_dir=f"./nondp-models/{DATASET}/{SHORT_NAME}_TL{TARGET_LAST}{GAMMA}_NL{NUMERICAL_LOSS}/{TRAIN_SIZE}_{RANDOM_SEED}_{EPSILON}_{NUM_DP_EPOCHS}_{ALPHA}_{LEARNING_RATE}",
...
save_file_path = f"./data/{DATASET}/synthetic/nonDP_{SHORT_NAME}_TL{TARGET_LAST}{GAMMA}_NL{NUMERICAL_LOSS}_{TRAIN_SIZE}_{RANDOM_SEED}_{EPSILON}_{NUM_DP_EPOCHS}_{ALPHA}_{LEARNING_RATE}_TEM{TEMPERATURE}.csv"
